...
DEFAULT_OUTPUT_DIR = Path(
    r"C:\ai\AnomalyDINO\results_CUSTOM\dinov3_vitb16_688"
    r"\8-shot_preprocess=force_no_mask_no_rotation_bestsearch8_fast20greedy_maxanomap_res688_evaltrain_20260413"
    r"\roi_normalmap_bbox_metrics_local_ring_ignore_black\bbox_normalmap_features12"
    r"\random_forest_groupcv_results_bbox12feat\final_all_boxes_thresholded_0p279259"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fit final ROI bbox Random Forest on labeled boxes, predict all boxes, and render overlays."
    )
    ...
    parser.add_argument("--threshold-3d", type=float, default=0.2792594730854034)
